...
rmsd first :1-226@CA out ${GFP}.rmsd.dat
rmsd first :64 out TYG.rmsd.dat
atomicfluct out ${GFP}_atomic-fluctuations-md.dat :1-226 byres
hbond donormask :1-63,65-226 acceptormask :TYG@O2,O3,OG1,OH,N1,N2,N3 out ${GFP}_nHBacc.dat avgout ${GFP}_avgHBacc.dat
hbond donormask :TYG@N1,OG1,OH acceptormask :1-63,65-226@O,OD1,OD2,OE1,OE2,OG,OG1,OH,NE2,ND1 out ${GFP}_nHBdon.dat avgout ${GFP}_avgHBdon.dat
go
quit
eoi
